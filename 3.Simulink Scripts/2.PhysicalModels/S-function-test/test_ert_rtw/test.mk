...
START_DIR                 = C:/Users/diego/Dropbox/Academic/MENGSP~1/35330~1.DOC/ADCS_C~1/35C17~1.SIM/2D225~1.PHY/S-FUNC~1
SOLVER                    = 
SOLVER_OBJ                = 
CLASSIC_INTERFACE         = 0
TGT_FCN_LIB               = None
...
OBJS = xcp_ext_mode.o test.o LED_Function_cgen_wrapper.o xcp_ext_common.o xcp_ext_classic_trigger.o xcp.o xcp_standard.o xcp_daq.o xcp_calibration.o xcp_fifo.o xcp_transport.o xcp_mem_default.o xcp_drv_rtiostream.o xcp_frame_serial.o xcp_ext_param_default_serial.o MW_ArduinoHWInit.o io_wrappers.o arduinoAVRScheduler.o rtiostream_serial_daemon.o
...
LED_Function_cgen_wrapper.o : $(START_DIR)/test_ert_rtw/LED_Function_cgen_wrapper.cpp
	$(CPP) $(CPPFLAGS) -o "$@" "$<"
