...
PRODUCT_NAME              = LCD_function
MAKEFILE                  = LCD_function.mk
MATLAB_ROOT               = C:/PROGRA~1/MATLAB/R2021b
MATLAB_BIN                = C:/PROGRA~1/MATLAB/R2021b/bin
MATLAB_ARCH_BIN           = $(MATLAB_BIN)/win64
START_DIR                 = C:/Users/diego/Dropbox/Academic/MENGSP~1/35330~1.DOC/ADCS_C~1/35C17~1.SIM/2D225~1.PHY/LCD
SOLVER                    = 
SOLVER_OBJ                = 
CLASSIC_INTERFACE         = 0
TGT_FCN_LIB               = None
...
SLIB_PATH        = C:/Users/diego/DOCUME~1/MATLAB/R2021b/ARDUIN~1/ARDUIN~2/FASTER~2
...
PRODUCT = $(RELATIVE_PATH_TO_ANCHOR)/LCD_function.elf
...
DEFINES_STANDARD = -DMODEL=LCD_function -DNUMST=1 -DNCSTATES=0 -DHAVESTDIO -DMODEL_HAS_DYNAMICALLY_LOADED_SFCNS=0
...
OBJS = xcp_ext_mode.o LCD_function.o LCD_function_data.o rtGetInf.o rtGetNaN.o rt_nonfinite.o Lcd_cgen_wrapper.o xcp_ext_common.o xcp_ext_classic_trigger.o xcp.o xcp_standard.o xcp_daq.o xcp_calibration.o xcp_fifo.o xcp_transport.o xcp_mem_default.o xcp_drv_rtiostream.o xcp_frame_serial.o xcp_ext_param_default_serial.o MW_ArduinoHWInit.o io_wrappers.o arduinoAVRScheduler.o rtiostream_serial_daemon.o
...
%.o : $(START_DIR)/LCD_function_ert_rtw/%.c
	$(CC) $(CFLAGS) -o "$@" "$<"


%.S.o : $(START_DIR)/LCD_function_ert_rtw/%.s
	$(AS) $(ASFLAGS) -o "$@" "$<"
...
%.o : $(START_DIR)/LCD_function_ert_rtw/%.cpp
	$(CPP) $(CPPFLAGS) -o "$@" "$<"
...
LCD_function.o : $(START_DIR)/LCD_function_ert_rtw/LCD_function.c
	$(CC) $(CFLAGS) -o "$@" "$<"


LCD_function_data.o : $(START_DIR)/LCD_function_ert_rtw/LCD_function_data.c
	$(CC) $(CFLAGS) -o "$@" "$<"


ert_main.o : $(START_DIR)/LCD_function_ert_rtw/ert_main.c
	$(CC) $(CFLAGS) -o "$@" "$<"


rtGetInf.o : $(START_DIR)/LCD_function_ert_rtw/rtGetInf.c
	$(CC) $(CFLAGS) -o "$@" "$<"


rtGetNaN.o : $(START_DIR)/LCD_function_ert_rtw/rtGetNaN.c
	$(CC) $(CFLAGS) -o "$@" "$<"


rt_nonfinite.o : $(START_DIR)/LCD_function_ert_rtw/rt_nonfinite.c
	$(CC) $(CFLAGS) -o "$@" "$<"


Lcd_cgen_wrapper.o : $(START_DIR)/LCD_function_ert_rtw/Lcd_cgen_wrapper.cpp
	$(CPP) $(CPPFLAGS) -o "$@" "$<"
