###########################################################################
## Makefile generated for component 'DAL_Sat_HW_v7'. 
## 
## Makefile     : DAL_Sat_HW_v7.mk
## Generated on : Sat Jan 22 11:25:02 2022
## Final product: $(RELATIVE_PATH_TO_ANCHOR)/DAL_Sat_HW_v7.elf
...
PRODUCT = $(RELATIVE_PATH_TO_ANCHOR)/DAL_Sat_HW_v7.elf
...
DEFINES_ = -D__MW_TARGET_USE_HARDWARE_RESOURCES_H__ -DMW_TIMERID=2 -DMW_PRESCALAR=256 -DMW_TIMERCOUNT=6 -DMW_SCHEDULERCOUNTER=25 -DARDUINO_NUM_SERIAL_PORTS=1 -D_RTT_BAUDRATE_SERIAL0_=9600 -D_RTT_ANALOG_REF_=0 -D_RTT_NUMSERVOS_=2
...
DEFINES_STANDARD = -DMODEL=DAL_Sat_HW_v7 -DNUMST=1 -DNCSTATES=0 -DHAVESTDIO -DMODEL_HAS_DYNAMICALLY_LOADED_SFCNS=0
...
OBJS = MW_ServoWriteRead.o MW_AnalogInput.o ArduinoPinHandleMap.o DAL_Sat_HW_v7.o DAL_Sat_HW_v7_data.o rtGetInf.o rtGetNaN.o rt_nonfinite.o MW_ArduinoHWInit.o io_wrappers.o arduinoAVRScheduler.o
...
%.o : $(START_DIR)/DAL_Sat_HW_v7_ert_rtw/%.c
	$(CC) $(CFLAGS) -o "$@" "$<"


%.S.o : $(START_DIR)/DAL_Sat_HW_v7_ert_rtw/%.s
	$(AS) $(ASFLAGS) -o "$@" "$<"
...
%.o : $(START_DIR)/DAL_Sat_HW_v7_ert_rtw/%.cpp
	$(CPP) $(CPPFLAGS) -o "$@" "$<"
...
DAL_Sat_HW_v7.o : $(START_DIR)/DAL_Sat_HW_v7_ert_rtw/DAL_Sat_HW_v7.c
	$(CC) $(CFLAGS) -o "$@" "$<"


DAL_Sat_HW_v7_data.o : $(START_DIR)/DAL_Sat_HW_v7_ert_rtw/DAL_Sat_HW_v7_data.c
	$(CC) $(CFLAGS) -o "$@" "$<"


ert_main.o : $(START_DIR)/DAL_Sat_HW_v7_ert_rtw/ert_main.c
	$(CC) $(CFLAGS) -o "$@" "$<"


rtGetInf.o : $(START_DIR)/DAL_Sat_HW_v7_ert_rtw/rtGetInf.c
	$(CC) $(CFLAGS) -o "$@" "$<"


rtGetNaN.o : $(START_DIR)/DAL_Sat_HW_v7_ert_rtw/rtGetNaN.c
	$(CC) $(CFLAGS) -o "$@" "$<"


rt_nonfinite.o : $(START_DIR)/DAL_Sat_HW_v7_ert_rtw/rt_nonfinite.c
	$(CC) $(CFLAGS) -o "$@" "$<"
