...
void DAL_Sat_HW_ExtendedControl_step(void)
{
  ...
  /* S-Function (LCDControlSF): '<S28>/S-Function Builder' */
  LCDControlSF_Outputs_wrapper_cgen
    (&DAL_Sat_HW_ExtendedControl_B.DataTypeConversion1,
     &DAL_Sat_HW_ExtendedControl_DW.SFunctionBuilder_DSTATE);
  ...
  /* Update for S-Function (LCDControlSF): '<S28>/S-Function Builder' */

  /* S-Function "LCDControlSF_wrapper" Block: <S28>/S-Function Builder */
...
void DAL_Sat_HW_ExtendedControl_initialize(void)
{
...

  {
    ...
    /* InitializeConditions for S-Function (LCDControlSF): '<S28>/S-Function Builder' */
    ...
    /* S-Function Block: <S28>/S-Function Builder */
    {
...

      {
        int_T i1;
        for (i1=0; i1 < 1; i1++) {
          DAL_Sat_HW_ExtendedControl_DW.SFunctionBuilder_DSTATE = initVector[0];
        }
      }
    }
