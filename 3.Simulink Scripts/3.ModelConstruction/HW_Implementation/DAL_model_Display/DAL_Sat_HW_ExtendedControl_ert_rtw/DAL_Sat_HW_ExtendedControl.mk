###########################################################################
## Makefile generated for component 'DAL_Sat_HW_ExtendedControl'. 
## 
## Makefile     : DAL_Sat_HW_ExtendedControl.mk
## Generated on : Sat Jan 22 23:58:13 2022
## Final product: $(RELATIVE_PATH_TO_ANCHOR)/DAL_Sat_HW_ExtendedControl.elf
...
PRODUCT_NAME              = DAL_Sat_HW_ExtendedControl
MAKEFILE                  = DAL_Sat_HW_ExtendedControl.mk
MATLAB_ROOT               = C:/PROGRA~1/MATLAB/R2021b
MATLAB_BIN                = C:/PROGRA~1/MATLAB/R2021b/bin
MATLAB_ARCH_BIN           = $(MATLAB_BIN)/win64
START_DIR                 = C:/Users/diego/Dropbox/Academic/MENGSP~1/35330~1.DOC/ADCS_C~1/35C17~1.SIM/3E193~1.MOD/HW_IMP~1/DAL_MO~2
SOLVER                    = 
SOLVER_OBJ                = 
CLASSIC_INTERFACE         = 0
TGT_FCN_LIB               = None
...
PRODUCT = $(RELATIVE_PATH_TO_ANCHOR)/DAL_Sat_HW_ExtendedControl.elf
...
DEFINES_ = -D__MW_TARGET_USE_HARDWARE_RESOURCES_H__ -DMW_TIMERID=2 -DMW_PRESCALAR=256 -DMW_TIMERCOUNT=6 -DMW_SCHEDULERCOUNTER=25 -DARDUINO_NUM_SERIAL_PORTS=1 -D_RTT_BAUDRATE_SERIAL0_=9600 -D_RTT_ANALOG_REF_=0 -D_RTT_NUMSERVOS_=1
...
DEFINES_STANDARD = -DMODEL=DAL_Sat_HW_ExtendedControl -DNUMST=1 -DNCSTATES=0 -DHAVESTDIO -DMODEL_HAS_DYNAMICALLY_LOADED_SFCNS=0
...
SRCS = C:/ProgramData/MATLAB/SupportPackages/R2021b/toolbox/target/supportpackages/arduinobase/src/MW_ServoWriteRead.cpp C:/ProgramData/MATLAB/SupportPackages/R2021b/toolbox/target/supportpackages/arduinobase/src/MW_AnalogInput.cpp C:/ProgramData/MATLAB/SupportPackages/R2021b/toolbox/target/supportpackages/arduinobase/src/ArduinoPinHandleMap.cpp $(START_DIR)/DAL_Sat_HW_ExtendedControl_ert_rtw/DAL_Sat_HW_ExtendedControl.c $(START_DIR)/DAL_Sat_HW_ExtendedControl_ert_rtw/DAL_Sat_HW_ExtendedControl_data.c $(START_DIR)/DAL_Sat_HW_ExtendedControl_ert_rtw/rtGetInf.c $(START_DIR)/DAL_Sat_HW_ExtendedControl_ert_rtw/rtGetNaN.c $(START_DIR)/DAL_Sat_HW_ExtendedControl_ert_rtw/rt_nonfinite.c $(START_DIR)/DAL_Sat_HW_ExtendedControl_ert_rtw/LCDControlSF_cgen_wrapper.cpp $(START_DIR)/LCDControlSF_wrapper.cpp C:/ProgramData/MATLAB/SupportPackages/R2021b/toolbox/target/supportpackages/arduinotarget/registry/../src/MW_ArduinoHWInit.cpp C:/ProgramData/MATLAB/SupportPackages/R2021b/toolbox/target/supportpackages/arduinobase/src/io_wrappers.cpp C:/ProgramData/MATLAB/SupportPackages/R2021b/toolbox/target/supportpackages/arduinotarget/registry/../scheduler/src/arduinoAVRScheduler.cpp

MAIN_SRC = $(START_DIR)/DAL_Sat_HW_ExtendedControl_ert_rtw/ert_main.c
...
OBJS = MW_ServoWriteRead.o MW_AnalogInput.o ArduinoPinHandleMap.o DAL_Sat_HW_ExtendedControl.o DAL_Sat_HW_ExtendedControl_data.o rtGetInf.o rtGetNaN.o rt_nonfinite.o LCDControlSF_cgen_wrapper.o LCDControlSF_wrapper.o MW_ArduinoHWInit.o io_wrappers.o arduinoAVRScheduler.o
...
%.o : $(START_DIR)/DAL_Sat_HW_ExtendedControl_ert_rtw/%.c
	$(CC) $(CFLAGS) -o "$@" "$<"


%.S.o : $(START_DIR)/DAL_Sat_HW_ExtendedControl_ert_rtw/%.s
	$(AS) $(ASFLAGS) -o "$@" "$<"
...
%.o : $(START_DIR)/DAL_Sat_HW_ExtendedControl_ert_rtw/%.cpp
	$(CPP) $(CPPFLAGS) -o "$@" "$<"
...
DAL_Sat_HW_ExtendedControl.o : $(START_DIR)/DAL_Sat_HW_ExtendedControl_ert_rtw/DAL_Sat_HW_ExtendedControl.c
	$(CC) $(CFLAGS) -o "$@" "$<"


DAL_Sat_HW_ExtendedControl_data.o : $(START_DIR)/DAL_Sat_HW_ExtendedControl_ert_rtw/DAL_Sat_HW_ExtendedControl_data.c
	$(CC) $(CFLAGS) -o "$@" "$<"


ert_main.o : $(START_DIR)/DAL_Sat_HW_ExtendedControl_ert_rtw/ert_main.c
	$(CC) $(CFLAGS) -o "$@" "$<"


rtGetInf.o : $(START_DIR)/DAL_Sat_HW_ExtendedControl_ert_rtw/rtGetInf.c
	$(CC) $(CFLAGS) -o "$@" "$<"


rtGetNaN.o : $(START_DIR)/DAL_Sat_HW_ExtendedControl_ert_rtw/rtGetNaN.c
	$(CC) $(CFLAGS) -o "$@" "$<"


rt_nonfinite.o : $(START_DIR)/DAL_Sat_HW_ExtendedControl_ert_rtw/rt_nonfinite.c
	$(CC) $(CFLAGS) -o "$@" "$<"


LCDControlSF_cgen_wrapper.o : $(START_DIR)/DAL_Sat_HW_ExtendedControl_ert_rtw/LCDControlSF_cgen_wrapper.cpp
	$(CPP) $(CPPFLAGS) -o "$@" "$<"


LCDControlSF_wrapper.o : $(START_DIR)/LCDControlSF_wrapper.cpp
	$(CPP) $(CPPFLAGS) -o "$@" "$<"
