...
void rt_OneStep(void)
{
  ...
  currentTime = (extmodeSimulationTime_T) Test9_M->Timing.clockTick0;
  Test9_step();
...
int main(void)
{
  ...
  errorCode = extmodeInit(Test9_M->extModeInfo, &rtmGetTFinal(Test9_M));
  if (errorCode != EXTMODE_SUCCESS) {
  ...
  if (errorCode == EXTMODE_SUCCESS) {
    ...
    if (extmodeStopRequested()) {
      rtmSetStopRequested(Test9_M, true);
    }
  }
