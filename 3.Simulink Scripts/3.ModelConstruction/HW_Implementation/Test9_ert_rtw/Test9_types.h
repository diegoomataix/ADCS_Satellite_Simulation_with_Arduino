...
#ifndef RTW_HEADER_Test9_types_h_
#define RTW_HEADER_Test9_types_h_
#include "rtwtypes.h"
...
typedef struct tag_UhdjAlk5m2xbK6E3oTj7hC codertarget_arduinobase_int_f_T;

#endif                             /* typedef_codertarget_arduinobase_int_f_T */

/* Custom Type definition for MATLABSystem: '<S3>/Analog Input17' */
#include "MW_SVD.h"
...
#ifndef typedef_codertarget_arduinobase_in_fs_T
#define typedef_codertarget_arduinobase_in_fs_T

typedef struct tag_8ohiN1FAOgR98njPNu14NC codertarget_arduinobase_in_fs_T;

#endif                             /* typedef_codertarget_arduinobase_in_fs_T */

/* Parameters for system: '<S7>/Standard Servo Read' */
typedef struct P_StandardServoRead_Test9_T_ P_StandardServoRead_Test9_T;

/* Parameters for system: '<S23>/If Action Subsystem' */
typedef struct P_IfActionSubsystem_Test9_T_ P_IfActionSubsystem_Test9_T;

/* Parameters (default storage) */
typedef struct P_Test9_T_ P_Test9_T;

/* Forward declaration for rtModel */
typedef struct tag_RTM_Test9_T RT_MODEL_Test9_T;

#endif                                 /* RTW_HEADER_Test9_types_h_ */
